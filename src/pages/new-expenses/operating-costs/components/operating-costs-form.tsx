...
export default function OperatingCostsForm() {
  return (
    <div className="mx-auto p-4 md:p-8 space-y-5 w-full">
      ...
      <div className="flex items-center">
        <label className="w-1/3 font-medium text-gray-600">Service Provider:</label>
        <input
          type="text"
          className="w-2/3 border-b-2 border-gray-300/50 focus:outline-none focus:border-black/30"
        />
      ...
      <div className="flex items-center">
        <label className="w-1/3 font-medium text-gray-600">Product Seller:</label>
        <input
          type="text"
          className="w-2/3 border-b-2 border-gray-300/50 focus:outline-none focus:border-black/30"
        />
